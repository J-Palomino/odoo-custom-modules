...
MASTER_CATEGORY_PATTERNS = {
    ...
    'Edibles & Tinctures': [
        ...
        # five categories holding 2,804 products and not one of them an edible:
        ...
        # credit. Nothing legitimate is lost: no breath-mint category exists,
        # and 'Lozenge' remains its own fragment.
    ...
    'Concentrates & Topicals': [
        ...
        # under "Cannabis / Cured Resin", which no bucket covered, so concentrate
        # deals for Canamo (435 AZ products), Dr. Greenthumb (137), The Pharm
        # (84), Diablo and Gelato resolved to nothing — 27 deals matching zero.
        #
        # KNOWN TRADE-OFF: substring matching also pulls in three vape
        # categories — "Cartridge: Cured Resin" (116), "Cured Resin Cartridge"
        # (7), "Cured Resin Disposable" (3) — so 126 cart SKUs become reachable
        # from a concentrates deal. Accepted because it recovers 1,495 and
        # mirrors the pre-existing 'Rosin' overlap (Live Rosin / Cartridge:
        # Rosin already match both Vapes and Concentrates). The clean fix is
        # exclusion support or exact-name patterns in
        # _resolve_master_categories; this list cannot express "not a cart".
        'Cured Resin',
    ],
