...
list_presets() {
  ...
  echo ""
  echo "  green    - Mint Green (#00954c) - Default"
...
# ============================================================
# GENERATE PRIMARY VARIABLES FILE
# ============================================================
# This file is loaded in web._assets_primary_variables BEFORE
# Odoo core SCSS compilation, ensuring all 164+ derived colors
# use our brand color instead of default purple.

cat > "$PRIMARY_VARS_FILE" << PVSCSS
// Mint brand SCSS variable overrides
// Loaded in web._assets_primary_variables BEFORE Odoo core SCSS compilation
// This ensures all 164+ derived colors use our brand green instead of default purple
//
// Generated by: generate-theme.sh
// Generated at: $(date -u +"%Y-%m-%d %H:%M:%S UTC")
