...
# Originally dropped 2026-05-20 (e1d1875) after v19-incompat bugs in the
# 18→19 port. Staging branch has carried fixes since 2026-05-22 (await
# import → lazy load; mgmtsystem_nonconformity uses add_records_fields).
# Re-shipped 2026-05-27 — see memory entry `oca-bundle-v19-working-set`.
